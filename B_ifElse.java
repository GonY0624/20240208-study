...
public class B_ifElse {
    ...
    *   라고 출력하고,
    *   홀수가 아니면 "입력하시 숫자는 짝수입니다. " 라고 출력하는 프로그램을 작성해보자.
    *   단, 조건과 상관 없이 프로그램이 종료될 때, "프로그램이 종료됩니다. " 라고 출력되도록 하자.
    *  */
    ...
    public void testNestedIfElseStatement(){
        ...
        *  */
        ...
        if(num != 0){
            ...
            if(num > 0){
                System.out.println("입력하신 숫자는 0이 아닌 양수입니다. ");

            } else {
                System.out.println("입력하신 숫자는 0이 아닌 음수입니다. ");
