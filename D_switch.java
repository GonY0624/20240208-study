...
public class D_switch {
    ...
    public void testSimpleSwitchStatement(){
        ...
        *   [switch 문 표현식]
        *   switch(비교할 변수) {
        *       case 비굣값1 : 비교값1 과 일치하는 경우 실행할 구문; break;
        *       case 비굣값2 : 비교값2 과 일치하는 경우 실행할 구문; break;
        ...
        *   실수와 논리는 비교할 수 없다.
        *   또한 정확하게 일치하는 경우만 비교할 수 있으며, 대소 비교를 할 수 없다는게
        *   차이점이다.
        *  */
        ...
        *  */
        ...
        char op = sc.next().charAt(0); //문자 가지고 오는거, 0 -> 첫번쨰 문자를 반환받는 다는 것!

        /* 필기. 연산의 결과를 저장할 변수 생성 */
        int result = 0; //값을 공간만 만들어 놓은 것
    ...
    public void testSwitchVendingMachine() {
        ...
        /* 필기. switch 문을 이용해서 문자열 값 비교 및 break 에 대한 테스트 */
        ...
        switch (selectDrink) {
            ...
            case "솔의눈" :
                System.out.println("솔의눈을 왜 선택했니?.");
                price = 700;
                break;
