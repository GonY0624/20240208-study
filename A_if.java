...
public class A_if {
    ...
    public void testSimpleIfStatement(){
        ...
        *  */
        ...
        /* 필기.
        *   정수 한 개를 입력 받아 그 수가 짝수이면 "입력 하신 숫자는 짝수입니다. "
    ...
    public void testNestedIfStatement(){
        ...
        *   둘 중 하나라고 해당하지 않으면 아무 내용도 출력하지 않는 구문을
        *   작성해보자.
        *   단, 조건과 상관 없이 프로그램이 종료될 때 "프로그램은 종료합니다. "
        *   라고 출력되로록 한다.
        *  */

        Scanner sc = new Scanner(System.in); // { 중괄호 안에서 } 지역변수는 이름이 같아도 상관 x
